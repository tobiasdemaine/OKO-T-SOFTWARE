...
Declare Function BASS_ChannelBytes2Seconds Lib "bass.dll" (ByVal handle As Long, ByVal pos As Long) As Single
...
Declare Function BASS_ChannelSetPosition Lib "bass.dll" (ByVal handle As Long, ByVal pos As Long) As Long
